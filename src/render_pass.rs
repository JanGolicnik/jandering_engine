...
use crate::{
    object::Renderable,
    renderer::{BindGroupHandle, BufferHandle, ShaderHandle, TargetTexture, TextureHandle},
    types::Vec3,
    window::Window,
};
...
pub struct RenderStep {
    ...
    pub(crate) bind_groups: HashMap<u32, BindGroupHandle>,
...
impl<'renderer> RenderPass<'renderer> {
    ...
    pub fn bind(mut self, slot: u32, bind_group: BindGroupHandle) -> Self {
        self.steps
            .last_mut()
            .unwrap()
            .bind_groups
